...
<body>
    ...
    if (isset($_POST["submit"])) {
        ...
        if (empty($_POST["HOBBIES"])) {
        } elseif (in_array("Others", $_POST["HOBBIES"])) {
            if (empty($_POST["Hobbie"])) {
                echo "<tr><td>Hobbie</td><td>If selected Other in hobbies, write in the input box</td></tr>";
            } else {
            ...
            if (empty($_POST["COURSES"])) {
                echo "<tr><td>Course </td><td>Select a course</td></tr>";
            } else {
                    ...
                    <table id="table">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if (isset($_POST["submit"]) && empty($_POST["HOBBIES"])) echo "<tr><td></td><td>{$error['hobby1']}</td></tr>"; ?>
                            ...
                            <td>
                                <table width="600px" , height="100px">
                                    ...
                                    <tr>
                                        <td>1.</td>
                                        <th>Class X</th>
                                        <td> <input type="text" name="Xboard" size="20"
                                                maxlength="20" /></td>
                                        <td><input type="text" name="Xpercentage" size="15"
                                                maxlength="10" /></td>
                                        <td><input type="text" name="Xpass" size="15"
                                                maxlength="4" /></td>
                                    ...
                                    <tr>
                                        <td>2.</td>
                                        <th>Class XII</th>
                                        <td> <input type="text" name="XIIboard" size="20"
                                                maxlength="20" /></td>
                                        <td><input type="text" name="XIIpercentage" size="15"
                                                maxlength="10" /></td>
                                        <td><input type="text" name="XIIpass" size="15"
                                                maxlength="10" /></td>
                                    </tr>
                                    <tr>
                                        <td>3.</td>
                                        <th>Graduation</th>
                                        <td> <input type="text" name="Gboard" size="20"
                                                maxlength="20" /></td>
                                        <td><input type="text" name="Gpercentage" size="15"
                                                maxlength="10" /></td>
                                        <td><input type="text" name="Gpass" size="15"
                                                maxlength="10" /></td>
                                    </tr>
                                    <tr>
                                        <td>4.</td>
                                        <th>Masters</th>
                                        <td> <input type="text" name="Mboard" size="20"
                                                maxlength="20" /></td>
                                        <td><input type="text" name="Mpercentage" size="15"
                                                maxlength="10" /></td>
                                        <td><input type="text" name="Mpass" size="15"
                                                maxlength="10" /></td>
                                    </tr>
                                    <tr>
                                        <td></td>
